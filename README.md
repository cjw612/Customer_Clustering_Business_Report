...
- ### Limitations
  ...
  - **Limited Clustering Methodology:** Without customer metadata to verify our clustering hypotheses, only one clustering method (K-Means) is deployed in this analysis. However, other clustering methods such as 
Hierarchical clustering may potentially deliver results that are superior to K-Means clustering in terms of interpretability and practicality. 
